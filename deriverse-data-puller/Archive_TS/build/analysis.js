...
async function fetchIncrementalData() {
    ...
    try {
        ...
        const accounts = await fetchAllAccounts();
        const newAccounts = accounts.filter(acc => !processedAccounts.has(acc.pubkey.toString()));
...
// Export functions
export { analyzeDeriverse, exportData, fetchIncrementalData };
